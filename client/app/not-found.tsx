  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-center p-6 sm:p-10">
      ...
      <div className="flex items-center gap-4 mb-6 animate-fade-in">
        ...
        <h1 className="text-6xl sm:text-7xl md:text-8xl font-extrabold text-purple-600 drop-shadow-lg">404</h1>
      </div>
      ...
      <Link href="/" className="px-6 py-3 rounded-xl bg-purple-600 text-white font-medium shadow-md hover:bg-purple-700 transition-all duration-300">
        Kembali ke Beranda
      </Link>
    </div>
  );
